...
if is_available "flutter-tools.nvim" then
  maps.n["<leader>ff"] = { "<cmd>FlutterRun<cr>", desc = "Flutter: Run" }
  maps.n["<leader>fr"] = { "<cmd>FlutterRestart<cr>", desc = "Flutter: Restart" }
  maps.n["<leader>fh"] = { "<cmd>FlutterHotReload<cr>", desc = "Flutter: Hot Reload" }
  maps.n["<leader>fs"] = { "<cmd>FlutterStop<cr>", desc = "Flutter: Stop" }
  maps.n["<leader>fu"] = { "<cmd>FlutterUpgrade<cr>", desc = "Flutter: Upgrade" }
  maps.n["<leader>fc"] = { "<cmd>FlutterClean<cr>", desc = "Flutter: Clean" }
  ...
  maps.n["<leader>ft"] = { "<cmd>FlutterTest<cr>", desc = "Flutter: Test" }
  maps.n["<leader>fk"] = { "<cmd>FlutterKill<cr>", desc = "Flutter: Kill" }
  maps.n["<leader>fi"] = { "<cmd>FlutterInstall<cr>", desc = "Flutter: Install" }
  maps.n["<leader>fb"] = { "<cmd>FlutterBuild<cr>", desc = "Flutter: Build" }
  maps.n["<leader>fl"] = { "<cmd>FlutterLogs<cr>", desc = "Flutter: Logs" }
  end
